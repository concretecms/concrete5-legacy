...
ccm_showDashboardNewsflowWelcome = function() {
	...
	ccm_showNewsflowOverlayWindow(CCM_BASE_PATH + '/dashboard/home?_ccm_dashboard_external=1', function() {
...
ccm_showAppIntroduction = function() {
	ccm_showNewsflowOverlayWindow(CCM_BASE_PATH + '/dashboard/welcome?_ccm_dashboard_external=1');
}
