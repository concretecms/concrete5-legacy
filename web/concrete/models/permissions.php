...
class PermissionsCache
{
    ...
    public function getIdentifier($obj)
    {
        if (is_a($obj, "Page")) {
            ...
            $id = $obj->getBlockID();
            $prefix = 'block';
        } elseif (is_a($obj, "CollectionVersion")) {
            $id = $obj->getVersionID();
            $prefix = 'collection_version';
        } elseif (is_a($obj, "Area")) {
            $id = $obj->getAreaID();
            $prefix = 'area';
        } elseif (is_a($obj, 'FileSet')) {
            $id = $obj->getFileSetID();
            $prefix = 'fileset';
    ...
    public function add($originalObj, $obj)
    {
...
class PermissionsProxy
{
    ...
    public function get($unknownObj)
    {
        ...
        } elseif (is_a($unknownObj, 'FileSet')) {
...
class Permissions extends Object
{
    ...
    *
    */
    public function Permissions(&$unknownObj)
    {
    ...
    public function getAddBlockTypes()
    {
    ...
    public function buildPermissionsFromArray($ar)
    {
        $str = '';
        //print_r($ar);
        if ($ar['canRead'] == 1) {
    ...
    public function loadPermissionSet($pObj)
    {
...
class CollectionPermissions extends Permissions
{
    ...
    public function CollectionPermissions(&$cObj)
    {
        $u = new User();
    ...
    public function setGroupAccess(&$cObj, &$u)
    {
        if (!$u->isRegistered()) {
...
class AreaPermissions extends Permissions
{
    ...
    public function AreaPermissions($aObj)
    {
        $u = new User();
    ...
    public function setGroupAccess(&$aObj, &$u)
    {
        $db = Loader::db();
        $groups = $u->getUserGroups();
        $groupIDs = array();
...
{
    public function BlockPermissions(&$bObj)
    {
        $u = new User();
    ...
    public function setGroupAccess(&$bObj, &$u, &$cv)
    {
        $db = Loader::db();
        $groups = $u->getUserGroups();
...
class FileSetPermissions extends Permissions
{
    ...
    public function setGroupAccess($fs, $u)
    {
        $db = Loader::db();
        $groups = $u->getUserGroups();
        $inStr = '(' . implode(',', array_keys($groups)) . ')';
