...
class job extends Object
{
    ...
    */
    ...
    final public static function jobClassLocations()
    {
    ...
    final public static function authenticateRequest($auth)
    {
    ...
    final public static function generateAuth()
    {
        $val = PASSWORD_SALT . ':' . DIRNAME_JOBS;
    ...
    final public static function getByID( $jID=0 )
    {
        $db = Loader::db();
    ...
    final public static function getByHandle( $jHandle='' )
    {
        $db = Loader::db();
    ...
    final public static function getJobObjByHandle( $jHandle='', $jobData=array() )
    {
    ...
    final public static function getAvailableList($includeConcreteDirJobs=1)
    {
        $jobObjs=array();
    ...
    final public static function runAllJobs()
    {
    ...
    final public function executeJob()
    {
