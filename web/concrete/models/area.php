...
class area extends Object
{
        ...
        */
        ...
        if (is_object($area)) {
            if ($area->isGlobalArea() == $arIsGlobal) {
                return $area;
            } elseif (!$area->isGlobalArea() && !$arIsGlobal) {
                return $area;
            }
        }
    ...
    */
    public function revertToPagePermissions()
    {
        ...
        } elseif ($areac->overrideTemplatePermissions()) {
    ...
    public function rescanAreaPermissionsChain()
    {
        ...
        if (is_a($areac, 'Page')) {
            ...
            } elseif ($areac->getCollectionInheritance() == 'TEMPLATE') {
     ...
     * @return void
     */
    public function setBlockWrapperStart($html, $hasReplacements = false)
    {
     ...
     * @return void
     */
    public function setBlockWrapperEnd($html, $hasReplacements = false)
    {
