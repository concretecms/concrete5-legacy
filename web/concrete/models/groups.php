    ...
    class GroupList extends Object
    {
        ...
        private function getRelevantGroups($obj, $omitRequiredGroups = false)
        {
            ...
            if ($obj instanceof Block) {
                ...
                $where = "fsID = '{$fsID}'";
            } elseif ($obj instanceof FileSetList) {
                $table = 'FileSetPermissions';
                $fsIDs = array();
            ...
            } elseif ($obj instanceof TaskPermissionList) {
            ...
            } elseif ($obj instanceof UserInfo) {
                $table = 'UserGroups';
                $uID = $obj->getUserID();
                if ($uID) {
                    $where = "uID = {$uID}";
        ...
        */
        ...
        public function setPermissionsForObject($obj)
        {
            ...
            if ($obj instanceof Block) {
                ...
                $this->permissions = $p;
            } elseif ($obj instanceof TaskPermission) {
