...
class Package extends Object
{
    ...
    */
    public function getPackageDateInstalled($type = 'system')
    {
    ...
    */
    ...
    public static function getItemName($item)
    {
        ...
        } elseif ($item instanceof ConfigValue) {
        ...
        } elseif (is_a($item, 'TaskPermission')) {
