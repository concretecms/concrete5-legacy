...
?>
    ...
    foreach ($gArray as $g) {
        ...
        if ($display) { ?>
            <tr class="no-bg" id="_row:gID:<?=$g->getGroupID()?>">
                ...
                <td><div style="text-align: center"><input type="checkbox" name="canRead_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($g->canRead()) { ?> checked<?php } ?>></div></td>
                <td><div style="text-align: center"><input type="checkbox" name="canSearch_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($g->canSearchFiles()) { ?> checked<?php } ?>></div></td>
                <td><div style="text-align: center"><input type="checkbox" name="canWrite_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($g->canWrite()) { ?> checked<?php } ?>></div></td>
                <td><div style="text-align: center"><input type="checkbox" name="canAdmin_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($g->canAdmin()) { ?> checked<?php } ?>></div></td>
            </tr>
        <?php
            $rowNum++;
            } ?>
    ...
    foreach ($uArray as $ui) {
       ...
       <tr class="no-bg" id="_row:uID:<?=$ui->getUserID()?>">
            ...
            <td><div style="text-align: center"><input type="checkbox" name="canRead_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($ui->canRead()) { ?> checked<?php } ?>></div></td>
            <td><div style="text-align: center"><input type="checkbox" name="canSearch_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($ui->canSearchFiles()) { ?> checked<?php } ?>></div></td>
            <td><div style="text-align: center"><input type="checkbox" name="canWrite_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($ui->canWrite()) { ?> checked<?php } ?>></div></td>
            <td><div style="text-align: center"><input type="checkbox" name="canAdmin_<?=$selectedEntity?>" value="<?=FilePermissions::PTYPE_ALL?>"<?php if ($ui->canAdmin()) { ?> checked<?php } ?>></div></td>
        </tr>
    <?php
        $rowNum++;
        } ?>
