...
<?php } else {
	...
	<div class="input">
	   ...
	   <?php if ($permissionsInherit == '-1') { ?>	<option value="-1" selected><?=t('** Multiple Settings')?></option><?php } ?>
		<option value="PARENT" <?php if ($permissionsInherit == 'PARENT') { ?>selected<?php } ?>><?=t('By Area of Site (Hierarchy)')?></option>
		<option value="TEMPLATE" <?php if ($permissionsInherit == 'TEMPLATE') { ?>selected<?php } ?>><?=t('From Page Type Defaults')?></option>
		<option value="OVERRIDE" <?php if ($permissionsInherit == 'OVERRIDE') { ?>selected<?php } ?>><?=t('Manually')?></option>
	  </select>
	</div>
	</div>
	...
	<div class="input">
		<select id="ccm-page-permissions-subpages-override-template-permissions" style="width: 260px">
		   	<?php if ($permissionsSubpageOverride == '-1') { ?><option value="-1" selected><?=t('** Multiple Settings')?></option><?php } ?>
			<option value="0" <?php if ($permissionsSubpageOverride == '0') { ?>selected<?php } ?>><?=t('Inherit page type default permissions.')?></option>
			<option value="1" <?php if ($permissionsSubpageOverride == '1') { ?>selected<?php } ?>><?=t('Inherit the permissions of this page.')?></option>
		</select>
	</div>
	</div>
