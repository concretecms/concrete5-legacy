...
function printAttributeRow($ak, $ek) {
	...
	<tr class="ccm-attribute-editable-field">
		<td width="250" style="vertical-align: middle"><strong><a href="javascript:void(0)">' . t($ak->getAttributeKeyName()) . '</a></strong></td>
	...
	$html = '
	<tr>
		<td width="250"><strong>' . t($ak->getAttributeKeyName()) . '</strong></td>
