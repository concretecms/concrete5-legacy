...
class graph
{
    ...
    */
    public function set_swf_path($path)
    {
        $this->swf_path = $path;
    }
    ...
    */
    public function format_output($function,$values)
    {
    ...
    */
    public function set_title( $title, $style='' )
    {
     ...
     */
    public function set_base( $base='js/' )
    {
        $this->base = $base;
    }

    // Number formatting:
    public function set_y_format( $val )
    {
        $this->y_format = $val;
    }

    public function set_num_decimals( $val )
    {
        $this->num_decimals = $val;
    }

    public function set_is_fixed_num_decimals_forced( $val )
    {
        $this->is_fixed_num_decimals_forced = $val?'true':'false';
    }

    public function set_is_decimal_separator_comma( $val )
    {
        $this->is_decimal_separator_comma = $val?'true':'false';
    }

    public function set_is_thousand_separator_disabled( $val )
    {
    ...
    // $val is a boolean
    public function set_x_offset( $val )
    {
     ...
     */
    public function set_tool_tip( $tip )
    {
     ...
     */
    public function set_x_labels( $a )
    {
        $tmp = array();
        foreach( $a as $item )
            $tmp[] = $this->esc( $item );
     ...
     */
    public function set_x_label_style( $size, $colour='', $orientation=0, $step=-1, $grid_colour='' )
    {
     ...
     */
    public function set_bg_image( $url, $x='center', $y='center' )
    {
        $this->bg_image = $url;
        $this->bg_image_x = $x;
        $this->bg_image_y = $y;
     ...
     */
    public function attach_to_y_right_axis( $data_number )
    {
     ...
     */
    public function set_inner_background( $col, $col2='', $angle=-1 )
    {
     ...
     */
    public function _set_y_label_style( $size, $colour )
    {
        $tmp = $size;
     ...
     *   The hex colour value.
     */
    public function set_y_label_style( $size, $colour='' )
    {
     ...
     *   The hex colour value.
     */
    public function set_y_right_label_style( $size, $colour='' )
    {
        $this->y_label_style_right = $this->_set_y_label_style( $size, $colour );
    }

    public function set_x_max( $max )
    {
        $this->x_max = floatval( $max );
    }

    public function set_x_min( $min )
    {
     ...
     *   The maximum value.
     */
    public function set_y_right_max( $max )
    {
     ...
     *   The minimum value.
     */
    public function set_y_right_min( $min )
    {
     ...
     *   Show the label on every $step label.
     */
    public function y_label_steps( $val )
    {
         $this->y_steps = intval( $val );
    }

    public function title( $title, $style='' )
    {
         $this->title = $this->esc( $title );
         if( strlen( $style ) > 0 )
                 $this->title_style = $style;
     ...
     */
    public function set_x_legend( $text, $size=-1, $colour='' )
    {
     ...
     */
    public function set_x_tick_size( $size )
    {
        if( $size > 0 )
     ...
     */
    public function set_x_axis_steps( $steps )
    {
        if ( $steps > 0 )
     ...
     */
    public function set_x_axis_3d( $size )
    {
        if( $size > 0 )
     ...
     */
    public function _set_y_legend( $text, $size, $colour )
    {
        $tmp = $text;
     ...
     */
    public function set_y_legend( $text, $size=-1, $colour='' )
    {
     ...
     *   The hex value of the font colour.
     */
    public function set_y_right_legend( $text, $size=-1, $colour='' )
    {
     ...
     */
    public function x_axis_colour( $axis, $grid='' )
    {
     ...
     */
    public function y_axis_colour( $axis, $grid='' )
    {
     ...
     */
    public function y_right_axis_colour( $colour )
    {
     ...
     *   Need to find out.
     */
    public function line( $width, $colour='', $text='', $size=-1, $circles=-1 )
    {
     ...
     *   Font size of the label.
     */
    public function line_dot( $width, $dot_size, $colour, $text='', $font_size='' )
    {
     ...
     *   Font size of the label.
     */
    public function line_hollow( $width, $dot_size, $colour, $text='', $font_size='' )
    {
     ...
     */
    public function area_hollow( $width, $dot_size, $colour, $alpha, $text='', $font_size='', $fill_colour='' )
    {
     ...
     *   Font size of the label.
     */
    public function bar( $alpha, $colour='', $text='', $size=-1 )
    {
     ...
     *   Font size of the label.
     */
    public function bar_filled( $alpha, $colour, $colour_outline, $text='', $size=-1 )
    {
    ...
    public function bar_sketch( $alpha, $offset, $colour, $colour_outline, $text='', $size=-1 )
    {
     ...
     *   Font size of the label.
     */
    public function bar_3D( $alpha, $colour='', $text='', $size=-1 )
    {
     ...
     *   Font size of the label.
     */
    public function bar_glass( $alpha, $colour, $outline_colour, $text='', $size=-1 )
    {
     ...
     *   Font size of the label.
     */
    public function bar_fade( $alpha, $colour='', $text='', $size=-1 )
    {
    ...
    public function candle( $data, $alpha, $line_width, $colour, $text='', $size=-1 )
    {
    ...
    public function hlc( $data, $alpha, $line_width, $colour, $text='', $size=-1 )
    {
    ...
    public function scatter( $data, $line_width, $colour, $text='', $size=-1 )
    {
     ...
     */
    public function pie_values( $values, $labels=array(), $links=array() )
    {
     ...
     */
    public function pie_slice_colours( $colours )
    {
...
class line
{
    ...
    public function line( $line_width, $colour )
    {
        $this->var = 'line';
    ...
    public function add_link( $data, $link )
    {
        $this->data[] = $data;
        $this->links[] = graph::esc( $link );
    }

    public function add_data_tip( $data, $tip )
    {
        $this->data[] = $data;
        $this->tips[] = graph::esc( $tip );
    }

    public function add_data_link_tip( $data, $link, $tip )
    {
        $this->data[] = $data;
        $this->links[] = graph::esc( $link );
        $this->tips[] = graph::esc( $tip );
    ...
    public function _get_variable_list()
    {
        $values = array();
    ...
    public function toString( $output_type, $set_num )
    {
...
class line_hollow extends line
{
    ...
    public function line_hollow( $line_width, $dot_size, $colour )
    {
...
{
    public function line_dot( $line_width, $dot_size, $colour )
    {
...
class bar
{
    ...
    public function bar( $alpha, $colour )
    {
        $this->var = 'bar';
...
{
    public function bar_3d( $alpha, $colour )
    {
...
{
    public function bar_fade( $alpha, $colour )
    {
        parent::bar( $alpha, $colour );
        $this->var = 'bar_fade';
    }
...
class bar_outline extends bar
{
    ...
    public function bar_outline( $alpha, $colour, $outline_colour )
    {
        parent::bar( $alpha, $colour );
        $this->var = 'filled_bar';
...
{
    public function bar_glass( $alpha, $colour, $outline_colour )
    {
...
class bar_sketch extends bar_outline
{
    ...
    public function bar_sketch( $alpha, $offset, $colour, $outline_colour )
    {
        parent::bar_outline( $alpha, $colour, $outline_colour );
        $this->var = 'bar_sketch';
        $this->offset = $offset;
...
class candle
{
    ...
    public function candle( $high, $open, $close, $low )
    {
        $this->out = array();
        $this->out[] = $high;
        $this->out[] = $open;
...
class hlc
{
    ...
    public function hlc( $high, $low, $close )
    {
        $this->out = array();
        $this->out[] = $high;
        $this->out[] = $low;
...
class point
{
    ...
    public function point( $x, $y, $size_px )
    {
        $this->out = array();
        $this->out[] = $x;
        $this->out[] = $y;
