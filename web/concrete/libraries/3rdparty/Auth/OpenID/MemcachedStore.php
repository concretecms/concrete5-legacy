...
class Auth_OpenID_MemcachedStore extends Auth_OpenID_OpenIDStore
{
     ...
     */
    public function Auth_OpenID_MemcachedStore($connection, $compress = false)
    {
     ...
     */
    public function associationKey($server_url, $handle = null)
    {
     ...
     * Memcache key is prefixed with 'openid_association_' string.
     */
    public function associationServerKey($server_url)
    {
