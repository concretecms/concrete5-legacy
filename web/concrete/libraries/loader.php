 ...
 */
 ...
 class Loader
 {
        ...
        public function element($file, $args = null)
        {
            ...
            if (file_exists(DIR_FILES_ELEMENTS . '/' . $file . '.php')) {
                include(DIR_FILES_ELEMENTS . '/' . $file . '.php');
            } elseif (file_exists(DIR_FILES_ELEMENTS_CORE . '/' . $file . '.php')) {
        ...
        public function tool($file, $args = null, $pkgHandle= null)
        {
           ...
           } elseif (file_exists(DIR_FILES_TOOLS_REQUIRED . '/' . $file . '.php')) {
        ...
        public function block($bl)
        {
            if (file_exists(DIR_FILES_BLOCK_TYPES . '/' . $bl . '/' . FILENAME_BLOCK_CONTROLLER)) {
            ...
            } elseif (file_exists(DIR_FILES_BLOCK_TYPES_CORE . '/' . $bl . '/' . FILENAME_BLOCK_CONTROLLER)) {
                ...
                if (is_object($bt)) {
                    ...
                    } elseif (file_exists(DIR_PACKAGES_CORE . '/' . $pkg . '/' . DIRNAME_BLOCKS . '/' . $bl . '/' . FILENAME_BLOCK_CONTROLLER)) {
        ...
        public function helper($file, $pkgHandle = false)
        {
            ...
            } elseif (file_exists(DIR_HELPERS . '/' . $file . '.php')) {
        ...
        public function pageTypeControllerPath($ctHandle)
        {
            ...
            } elseif (isset($packageDir) && (file_exists($packageDir . '/' . $pkgHandle . '/' . DIRNAME_CONTROLLERS . '/' . DIRNAME_PAGE_TYPES . '/' . $ctHandle . '.php'))) {
                $path = $packageDir . '/' . $pkgHandle . '/' . DIRNAME_CONTROLLERS . '/' . DIRNAME_PAGE_TYPES . '/' . $ctHandle . '.php';
            } elseif (file_exists(DIR_FILES_CONTROLLERS_REQUIRED . "/" . DIRNAME_PAGE_TYPES . "/{$ctHandle}.php")) {
        ...
        public function controller($item)
        {
            ...
            if ($item instanceof Page) {
                ...
                } elseif ($c->isGeneratedCollection()) {
            ...
            } elseif ($item instanceof Block || $item instanceof BlockType) {
                ...
                } elseif (file_exists(DIR_FILES_BLOCK_TYPES_CORE . '/' . $item->getBlockTypeHandle() . '/' . FILENAME_BLOCK_CONTROLLER)) {
                    require_once(DIR_FILES_BLOCK_TYPES_CORE . "/" . $item->getBlockTypeHandle() . "/" . FILENAME_BLOCK_CONTROLLER);
                } elseif ($item->getPackageID() > 0 && file_exists(DIR_PACKAGES . '/' . $item->getPackageHandle() . '/' . DIRNAME_BLOCKS . '/' . $item->getBlockTypeHandle() . '/' . FILENAME_BLOCK_CONTROLLER)) {
                    require_once(DIR_PACKAGES . '/' . $item->getPackageHandle() . '/' . DIRNAME_BLOCKS . '/' . $item->getBlockTypeHandle() . '/' . FILENAME_BLOCK_CONTROLLER);
                } elseif ($item->getPackageID() > 0 && file_exists(DIR_PACKAGES_CORE . '/' . $item->getPackageHandle() . '/' . DIRNAME_BLOCKS . '/' . $item->getBlockTypeHandle() . '/' . FILENAME_BLOCK_CONTROLLER)) {
            ...
            if ($path != '') {
                if (file_exists(DIR_FILES_CONTROLLERS . $controllerFile)) {
                    ...
                    $include = true;
                } elseif (file_exists(DIR_FILES_CONTROLLERS . $path . '/' . FILENAME_COLLECTION_CONTROLLER)) {
                    ...
                    if ($item->getPackageID() > 0 && (file_exists(DIR_FILES_CONTROLLERS . $controllerFile))) {
                        require_once(DIR_FILES_CONTROLLERS . $controllerFile);
                        $include = true;
                    } elseif ($item->getPackageID() > 0 && (file_exists(DIR_PACKAGES . '/' . $item->getPackageHandle() . '/' . DIRNAME_CONTROLLERS . $controllerFile))) {
                        require_once(DIR_PACKAGES . '/' . $item->getPackageHandle() . '/' . DIRNAME_CONTROLLERS . $controllerFile);
                        $include = true;
                    } elseif ($item->getPackageID() > 0 && (file_exists(DIR_PACKAGES . '/' . $item->getPackageHandle() . '/' . DIRNAME_CONTROLLERS . $path . '/'. FILENAME_COLLECTION_CONTROLLER))) {
                        require_once(DIR_PACKAGES . '/' . $item->getPackageHandle() . '/' . DIRNAME_CONTROLLERS . $path . '/'. FILENAME_COLLECTION_CONTROLLER);
                        $include = true;
                    } elseif ($item->getPackageID() > 0 && (file_exists(DIR_PACKAGES_CORE . '/' . $item->getPackageHandle() . '/' . DIRNAME_CONTROLLERS . $controllerFile))) {
                        require_once(DIR_PACKAGES_CORE . '/' . $item->getPackageHandle() . '/' . DIRNAME_CONTROLLERS . $controllerFile);
                        $include = true;
                    } elseif ($item->getPackageID() > 0 && (file_exists(DIR_PACKAGES_CORE . '/' . $item->getPackageHandle() . '/' . DIRNAME_CONTROLLERS . $path . '/'. FILENAME_COLLECTION_CONTROLLER))) {
                ...
                if (!$include) {
                    if (file_exists(DIR_FILES_CONTROLLERS_REQUIRED . $controllerFile)) {
                        ...
                        $include = true;
                    } elseif (file_exists(DIR_FILES_CONTROLLERS_REQUIRED . $path . '/' . FILENAME_COLLECTION_CONTROLLER)) {
