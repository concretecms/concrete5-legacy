...
class ConcreteUpgradeVersion560Helper {
	...
	public function run() {
		...
		$pageKeywords = array(
			'/dashboard/composer' => 'blog, blogging',
			'/dashboard/composer/write' => 'new blog, write blog, blogging',
			'/dashboard/composer/drafts' => 'blog drafts, composer',
			'/dashboard/sitemap' => 'pages, add page, delete page, copy, move, alias',
			'/dashboard/sitemap/full' => 'pages, add page, delete page, copy, move, alias',
			'/dashboard/sitemap/explore' => 'pages, add page, delete page, copy, move, alias, bulk',
			'/dashboard/sitemap/search' => 'find page, search page, search, find, pages, sitemap',
			'/dashboard/files/search' => 'add file, delete file, copy, move, alias, resize, crop, rename, images, title, attribute',
			'/dashboard/files/attributes' => 'file, file attributes, title, attribute, description, rename',
			'/dashboard/files/sets' => 'files, category, categories',
			'/dashboard/files/add_set' => 'new file set',
			'/dashboard/users' => 'users, groups, people, find, delete user, remove user, change password, password',
			'/dashboard/users/search' => 'find, search, people, delete user, remove user, change password, password',
			'/dashboard/users/groups' => 'user, group, people, permissions, access, expire',
			'/dashboard/users/attributes' => 'user attributes, user data, gather data, registration data',
			'/dashboard/users/add' => 'new user, create',
			'/dashboard/users/add_group' => 'new user group, new group, group, create',
			'/dashboard/users/group_sets' => 'group set',
			'/dashboard/reports' => 'forms, log, error, email, mysql, exception, survey',
			'/dashboard/reports/statistics' => 'hits, pageviews, visitors, activity',
			'/dashboard/reports/forms' => 'forms, questions, response, data',
			'/dashboard/reports/surveys' => 'questions, quiz, response',
			'/dashboard/reports/logs' => 'forms, log, error, email, mysql, exception, survey, history',
			'/dashboard/pages/themes' => 'new theme, theme, active theme, change theme, template, css',
			'/dashboard/pages/themes/add' => 'theme',
			'/dashboard/pages/themes/inspect' => 'page types',
			'/dashboard/pages/themes/customize' => 'custom theme, change theme, custom css, css',
			'/dashboard/pages/types' => 'page type defaults, global block, global area, starter, template',
			'/dashboard/pages/attributes' => 'page attributes, custom',
			'/dashboard/pages/single' => 'single, page, custom, application',
			'/dashboard/workflow' => 'add workflow, remove workflow',
			'/dashboard/blocks/stacks' => 'stacks, reusable content, scrapbook, copy, paste, paste block, copy block, site name, logo',
			'/dashboard/blocks/stacks/list' => 'edit stacks, view stacks, all stacks',
			'/dashboard/blocks/types' => 'block, refresh, custom',
			'/dashboard/extend' => 'add-on, addon, add on, package, applications, ecommerce, discussions, forums, themes, templates, blocks',
			'/dashboard/extend/install' => 'add-on, addon, ecommerce, install, discussions, forums, themes, templates, blocks',
			'/dashboard/extend/update' => 'update, upgrade',
			'/dashboard/extend/connect' => 'concrete5.org, my account, marketplace',
			'/dashboard/extend/themes' => 'buy theme, new theme, marketplace, template',
			'/dashboard/extend/add-ons' => 'buy addon, buy add on, buy add-on, purchase addon, purchase add on, purchase add-on, find addon, new addon, marketplace',
			'/dashboard/system' => 'dashboard, configuration',
			'/dashboard/system/basics/site_name' => 'website name, title',
			'/dashboard/system/basics/icons' => 'logo, favicon, iphone, icon, bookmark',
			'/dashboard/system/basics/editor' => 'tinymce, content block, fonts, editor, tinymce, content, overlay',
			'/dashboard/system/basics/multilingual' => 'translate, translation, internationalization, multilingual, translate',
			'/dashboard/system/basics/timezone' => 'timezone, profile, locale',
			'/dashboard/system/basics/interface' => 'interface, quick nav, dashboard background, background image',
			'/dashboard/system/seo/urls' => 'vanity, pretty url, seo, pageview, view',
			'/dashboard/system/seo/bulk_seo_tool' => 'bulk, seo, change keywords, engine, optimization, search',
			'/dashboard/system/seo/tracking_codes' => 'traffic, statistics, google analytics, quant, pageviews, hits',
			'/dashboard/system/seo/statistics' => 'turn off statistics, tracking, statistics, pageviews, hits',
			'/dashboard/system/seo/search_index' => 'configure search, site search, search option',
			'/dashboard/system/optimization/cache' => 'cache option, change cache, override, turn on cache, turn off cache, no cache, page cache, caching',
			'/dashboard/system/optimization/clear_cache' => 'cache option, turn off cache, no cache, page cache, caching',
			'/dashboard/system/optimization/jobs' => 'index search, reindex search, build sitemap, sitemap.xml, clear old versions, page versions, remove old',
			'/dashboard/system/permissions/site' => 'editors, hide site, offline, private, public, access',
			'/dashboard/system/permissions/files' => 'file options, file manager, upload, modify',
			'/dashboard/system/permissions/file_types' => 'security, files, media, extension, manager, upload',
			'/dashboard/system/permissions/tasks' => 'security, actions, administrator, admin, package, marketplace, search',
			'/dashboard/system/permissions/ip_blacklist' => 'security, lock ip, lock out, block ip, address, restrict, access',
			'/dashboard/system/permissions/captcha' => 'security, registration',
			'/dashboard/system/permissions/antispam' => 'antispam, block spam, security',
			'/dashboard/system/permissions/maintenance_mode' => 'lock site, under construction, hide, hidden',
			'/dashboard/system/registration/postlogin' => 'profile, login, redirect, specific, dashboard, administrators',
			'/dashboard/system/registration/profiles' => 'member profile, member page, community, forums, social, avatar',
			'/dashboard/system/registration/public_registration' => 'signup, new user, community',
			'/dashboard/system/mail' => 'smtp, mail settings',
			'/dashboard/system/mail/method' => 'email server, mail settings, mail configuration, external, internal',
			'/dashboard/system/mail/importers' => 'email server, mail settings, mail configuration, private message, message system, import, email, message',
			'/dashboard/system/attributes' => 'attribute configuration',
			'/dashboard/system/attributes/sets' => 'attributes, sets',
			'/dashboard/system/attributes/types' => 'attributes, types',
			'/dashboard/system/environment/info' => 'overrides, system info, debug, support, help',
			'/dashboard/system/environment/debug' => 'errors, exceptions, develop, support, help',
			'/dashboard/system/environment/logging' => 'email, logging, logs, smtp, pop, errors, mysql, errors, log',
			'/dashboard/system/environment/file_storage_locations' => 'security, alternate storage, hide files',
			'/dashboard/system/environment/proxy' => 'network, proxy server',
			'/dashboard/system/backup_restore' => 'export, backup, database, sql, mysql, encryption, restore',
			'/dashboard/system/backup_restore/update' => 'upgrade, new version, update',
			'/dashboard/system/backup_restore/database' => 'export, database, xml, starting, points, schema, refresh, custom, tables'
		);
