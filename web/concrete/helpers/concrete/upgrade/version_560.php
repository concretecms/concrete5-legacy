...
class ConcreteUpgradeVersion560Helper {
	...
	public function run() {
		...
		$pageKeywords = array(
			...
			'/dashboard/system/basics/editor' => 'tinymce, content block, fonts, editor, content, overlay',
			'/dashboard/system/basics/multilingual' => 'translate, translation, internationalization, multilingual',
			...
			'/dashboard/system/environment/logging' => 'email, logging, logs, smtp, pop, errors, mysql, log',
