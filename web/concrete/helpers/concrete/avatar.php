...
class ConcreteAvatarHelper
{
    ...
    * @return array $aDir
    */
    public function getStockAvatars()
    {
    ...
    */
    public function processUploadedAvatar($pointer, $uID)
    {
        $uHasAvatar = 0;
    ...
    * @return int $uHasAvatar
    */
    public function updateUserAvatar($pointer, $uID)
    {
    ...
    * @param int $uID
    */
    public function updateUserAvatarWithStock($pointer, $uID)
    {
        if ($pointer != "") {
