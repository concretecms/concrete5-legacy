    ...
    <div id="ccm-profile-body">	
        ...
        <div style="position:relative; width:100%; height:500px ;">
          ...
          if ($this->controller->getTask() == 'upload_avatar' && $error=="") {
            ...
            echo $html->javascript('jquery.Jcrop.js');
            echo $html->css('jquery.Jcrop.css');
            ?>
...
//                console.log('init',[xsize,ysize]);
          ...
          <?php }else{ ?>
            ...
            <?php if ($ui->hasAvatar()) {
              ?>
              <!--            <img src="--><?php //echo$av->getImagePath($ui,false);?><!--" style="max-width:100%; max-height:400px; height:auto;" id="avatarCropArea"/>-->
