        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                    ...
                    <?php } ?>
                            ...
                            <td width="33%">
                            <label>
                            <input type="checkbox" name="akID[]" value="<?=$ak->getAttributeKeyID()?>" <?php if (($this->controller->isPost() && in_array($ak->getAttributeKeyID(), $akIDArray))) { ?> checked <?php } elseif ((!$this->controller->isPost()) && $ct->isAvailableCollectionTypeAttribute($ak->getAttributeKeyID())) { ?> checked <?php } ?> />
