	...
	<input type="hidden" name="_disableLogin" value="1">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="password" name="uPassword" autocomplete="off" value="" style="width: 95%"> <?php    print $ih->button_js(t('Generate Password'), 'GeneratePassword();', 'left', 'info', array('style'=>'margin-top:5px; float:left;')); ?> <br/> <span id="generatedPassword" style="float: left; color: #C1C1C1; display: block; margin: 10px 0 0 10px;" ></span></td>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
        	<thead>
            	<tr>
                	<th colspan="2">
						<?php    echo t('Send User Information to Email Address');?>
					</th>
				</tr>
			</thead>
                <tr>
					<td colspan="2"><?php    print $fh->checkbox('send_user_info', '1', false); ?> <?php    echo t('Yes'); ?></td>
				</tr>
			</tbody>
		</table>
