...
function printAttributeRow($ak, $uo) {
	...
	<tr class="ccm-attribute-editable-field">
		<td width="250" style="vertical-align:middle;"><a style="font-weight:bold; line-height:18px;" href="javascript:void(0)">' . t($ak->getAttributeKeyDisplayHandle()) . '</a></td>
...
if (is_object($uo)) { 
	...
	<div class="ccm-pane-options">
		...
		<div class="row">
		<div class="span5" style=""><p><strong><?=t($uk->getAttributeKeyDisplayHandle())?></strong></p></div>
		<div class="span5"><p>
