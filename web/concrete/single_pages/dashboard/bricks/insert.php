...
if($permission) {	 
	...
	?>
	<form method="post" action="<?php echo $this->action($akCategoryHandle); ?>" id="new-object-form">
	<table width="100%">
		<tr>
			<td valign="top">
				<h1><a class="ccm-dashboard-header-option" style="right:130px;" href="<?php echo $this->url('/dashboard/bricks/structure/');?>">Global Attributes</a><a class="ccm-dashboard-header-option" href="<?php echo $this->url('/dashboard/bricks/structure/'.$akCategoryHandle)?>">Category Attributes</a><span><?php echo 'Add \''.$txt->unhandle($akCategoryHandle).'\''.t(' Item')?></span></h1>
			...
			<td valign="top" width="34%">
				...
				<div class="ccm-dashboard-inner">
					...
					<?php  print Loader::helper('attribute_key_category_item_permissions')->getForm(AttributeKeyCategoryItemPermission::getByID($akCategoryHandle), t('Set permissions for this item.')); ?>
				</div>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				...
				<div class="ccm-dashboard-inner">
					<?php
						...
						print $ih->submit('Add', 'new-object-form');
					?>
...
<?php } else { ?>
	...
	<?php if($names) { ?>
		...
		<h1><span><?php echo t('\''.$names->displayName.'\' Search')?></span></h1>
		<div class="ccm-dashboard-inner">
