						...
						?>
							<li>
								<label>
									...
									<span><?php echo t($ak->getAttributeKeyName())?></span>
		...
		<div class="ccm-attribute-sortable-set-list">
			...
			<?php foreach($sets as $asl) { ?>
				<div class="ccm-group" id="asID_<?php echo $asl->getAttributeSetID()?>">
					...
					<a class="ccm-group-inner" href="<?php echo $this->url('/dashboard/system/attributes/sets/', 'edit', $asl->getAttributeSetID())?>" style="background-image: url(<?php echo ASSETS_URL_IMAGES?>/icons/group.png)"><?php echo t($asl->getAttributeSetName())?></a>
				</div>
			<?php } ?>
		</div>
