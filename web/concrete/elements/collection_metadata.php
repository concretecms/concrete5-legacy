...
<? if (isset($_REQUEST['approveImmediately']) && $_REQUEST['approveImmediately']) { ?>
...
<input type="hidden" name="approveImmediately" value="<?=(isset($_REQUEST['approveImmediately']) && $_REQUEST['approveImmediately'])?>" />
