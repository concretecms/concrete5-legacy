...
<input type="hidden" name="rel" value="<?=$_REQUEST['rel']?>" />
	...
	<div id="ccm-page-paths-tab" style="display: none">
		...
		<?php if (!$c->isGeneratedCollection()) { ?>
			...
			print substr($c->cPath, 0, strrpos($c->cPath, '/'))?>/<input type="text" name="cHandle" class="ccm-input-text" value="<?php echo $cPath?>" id="cHandle"><input type="hidden" name="oldCHandle" value="<?php echo $c->getCollectionHandle()?>"><br /><br />
		<?php  } else { ?>
