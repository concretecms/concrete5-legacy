	...
	<div id="ccm-user-search-advanced-fields" class="ccm-search-advanced-fields" >
		...
		<div id="ccm-search-advanced-fields-inner">
			...
			<div id="ccm-search-fields-submit">
				<div id="ccm-search-export"><a href="javascript:void(0)" onclick="jQuery('#ccm-user-advanced-search').attr('action', '<?=REL_DIR_FILES_TOOLS_REQUIRED?>/users/search_results_export'); jQuery('#ccm-user-advanced-search').get(0).submit(); jQuery('#ccm-user-advanced-search').attr('action', '<?=REL_DIR_FILES_TOOLS_REQUIRED?>/users/search_results');"><?=t('Export All')?></a></div>
