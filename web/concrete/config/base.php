...
if (!defined('AVATAR_NONE')) {
	define('AVATAR_NONE', ASSETS_URL_IMAGES . '/avatar_none.png');
}
...
if (!defined('DIRNAME_CONVERSATION_EDITOR')) {
...
if (!defined('FILENAME_CONVERSATION_EDITOR_FORM_MESSAGE')) {
	 define('FILENAME_CONVERSATION_EDITOR_FORM_MESSAGE', 'message.php');
}
if (!defined('FILENAME_CONVERSATION_EDITOR_FORM_REPLY')) {
	 define('FILENAME_CONVERSATION_EDITOR_FORM_REPLY', 'reply.php');
}

if (!defined('CONVERSATION_MESSAGE_ATTACHMENTS_PENDING_FILE_SET')) {
