...
$ft->define('mp4', t('MP4'), FileType::T_VIDEO, 'video');
$ft->define('flv', t('FLV'), FileType::T_VIDEO, 'flv');
$ft->define('mp3', t('MP3'), FileType::T_AUDIO, 'audio', 'audio');
$ft->define('m4a', t('MP4'), FileType::T_AUDIO, 'audio', 'audio');
$ft->define('ra,ram', t('Realaudio'), FileType::T_AUDIO, 'audio');
$ft->define('wma', t('Windows Audio'), FileType::T_AUDIO, 'audio');
...
$ft->define('mpeg,mpg', t('MPEG'), FileType::T_VIDEO, 'video');
...
$ft->define('ogg', t('OGG'), FileType::T_AUDIO, 'audio');
$ft->define('ogv', t('OGG Video'), FileType::T_VIDEO, 'video');
$ft->define('webm', t('WebM'), FileType::T_VIDEO, 'video');
