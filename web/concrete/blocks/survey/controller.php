...
class SurveyBlockController extends BlockController
{
    ...
    public function getPollOptions() { return $this->options; }
    public function requiresRegistration() {return $this->requiresRegistration;}
    ...
    public function action_form_save_vote()
    {
        $u = new User();
        $db = Loader::db();
...
class BlockPollOption
{
    ...
    public function getOptionDisplayOrder() {return $this->displayOrder;}
