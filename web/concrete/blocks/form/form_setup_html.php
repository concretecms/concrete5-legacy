	...
	<div id="newQuestionBox">
		...
		<div class="fieldRow">
			...
			<div class="fieldValues">
				...
				<input name="answerType" type="radio" value="tel" /> <?php echo t('Telephone')?> &nbsp; <br>
	...
	<div id="editQuestionForm" style="display:none">
		...
		<div class="fieldRow">
			...
			<div class="fieldValues">
				...
				<input name="answerTypeEdit" type="radio" value="tel" /> <?php echo t('Telephone')?> &nbsp; <br>
				<input name="answerTypeEdit" type="radio" value="url" /> <?php echo t('Web Address')?>
			</div>
			<div class="ccm-spacer"></div>
		</div>
