        ...
        <table id="googleMapBlockSetup" width="100%" class="table"> 
            ...
            <tr>
                ...
                <td>
                    ...
                    <input id="ccm_googlemap_block_latitude" type="hidden" name="latitude" value="<?php echo $mapObj->latitude;?>" />
                    <input id="ccm_googlemap_block_longitude" type="hidden" name="longitude" value="<?php echo $mapObj->longitude;?>" />
                    <div id="ccm_googlemap_block_note" class="note"><?php echo t('Start typing a location then click on the correct entry on the list.')?></div>
            ...
            <tr>
                <th><?php echo t('Map Size')?>:</th>
                <td>                        
                    <div style="float: left; margin-right: 20px;">      
                        <label for="width"><?php echo t('Width')?>:</label>        
                        <input type="text" name="width" value="<?php echo ($width != 0) ? $width : '100%'; ?>" style="width: 40px; position: static; margin-right: -4px;">
                    </div>
                    <div style="float: left; margin-right: 20px;">
                        <label for="height"><?php echo t('Height')?>:</label>              
                        <input type="text" name="height" value="<?php echo ($height != 0) ? $height : '400px'; ?>" style="width: 40px; position: static; margin-right: -4px;">
                    </div>
                </td>
            </tr>	
        </table>
