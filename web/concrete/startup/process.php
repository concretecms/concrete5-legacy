<?php
    ...
    public function processMetaData($nvc)
    {
    ...
    if ($_POST['processCollection'] && $valt->validate()) {
        ...
        } elseif ($_POST['update_speed_settings']) {
        ...
        } elseif ($_POST['update_permissions']) {
            // updating a collection
            if ($cp->canAdminPage()) {
