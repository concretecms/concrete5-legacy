        ...
        switch ($co->getIncludeType()) {
            case "CONCRETE_TOOL":
                if (file_exists(DIR_FILES_TOOLS . '/' . $co->getFilename())) {
                    ...
                    $include = true;
                } elseif (file_exists(DIR_FILES_TOOLS_REQUIRED . '/' . $co->getFilename())) {
            ...
            case "BLOCK_TOOL":
                if ($co->getBlock() != '') {
                    ...
                    } elseif (file_exists(DIR_FILES_BLOCK_TYPES . '/' . $co->getBlock() . '/' . DIRNAME_BLOCK_TOOLS . '/' . $co->getFilename())) {
                        include(DIR_FILES_BLOCK_TYPES . '/' . $co->getBlock()  . '/' . DIRNAME_BLOCK_TOOLS .'/' . $co->getFilename());
                        $include = true;
                    } elseif (file_exists(DIR_FILES_BLOCK_TYPES_CORE . '/' . $co->getBlock()  . '/' . DIRNAME_BLOCK_TOOLS . '/' . $co->getFilename())) {
