	...
	public function getOptions($overrides = array()) {
		...
		switch($textEditorMode) {
			...
			case 'ADVANCED':
				...
				'plugins' => 'inlinepopups,safari,advlink,table,advhr,advimage,xhtmlxtras,emotions,insertdatetime,paste,visualchars,nonbreaking,pagebreak,style',
				'theme' => 'advanced',
			...
			case 'OFFICE':
				...
				//'spellchecker_languages' => '+English=en',
				'theme' => 'advanced',
				'plugins' => 'safari,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras', //,template,imagemanager,filemanager
				...
				'theme_advanced_buttons4' => 'charmap,emotions,iespell,media,advhr,|,fullscreen,|,styleprops,|,cite,del,ins,attribs,|,visualchars,nonbreaking,blockquote,pagebreak', //insertlayer,moveforward,movebackward,absolute,|,|,abbr,acronym,template,insertfile,insertimage
				'theme_advanced_blockformats' => 'p,address,pre,h1,h2,h3,div,blockquote,cite',
				'theme_advanced_fonts' => 'Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats',
				'theme_advanced_font_sizes' => '1,2,3,4,5,6,7',
				'theme_advanced_more_colors' => 1,
			...
			case 'BASIC':
				$textEditorOptions = array_merge($textEditorOptions, array(
					//'spellchecker_languages' => '+English=en',
					'theme' => 'simple',
					'plugins' => 'paste,inlinepopups,safari,advlink'
				));
				break;
			case 'SIMPLE':
			default:
				$textEditorOptions = array_merge($textEditorOptions, array(
					'theme' => 'concrete',
					'plugins' => 'paste,inlinepopups,safari,advlink,advimage,advhr',
					//'spellchecker_languages' => '+English=en'
				));
				break;
		}
