...
abstract class Concrete5_Model_TreeNode extends Object {
	...
	public function getTreeNodeTypeObject() {return TreeNodeType::getByID($this->treeNodeTypeID);}
	...
	public function overrideParentTreeNodePermissions() {return $this->treeNodeOverridePermissions;}
	public function getTreeNodePermissionsNodeID() {return $this->inheritPermissionsFromTreeNodeID;}
	...
	public static function add($parent = false) {
		...
		$treeNodeTypeHandle = Loader::helper('text')->uncamelcase(substr(get_called_class(), 0, strpos(get_called_class(), 'TreeNode')));
