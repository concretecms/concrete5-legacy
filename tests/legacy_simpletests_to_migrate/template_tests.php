...
class TemplateTests extends ConcreteTestCase {
    ...
    function testCoreBlockWithCustomTemplateFile() {
    ...
    function testCoreBlockWithCustomTemplateDirectory() {
...
class TemplateCoreWebTests extends UnitTestCase {
	...
	function testCoreBlockHeaderItems() {
		// Test g.
	...
	function testCoreBlockHeaderDirectoryItems() {
		// Test h
		self::$_this->headerItem1Count = 0;
		self::$_this->headerItem2Count = 0;
		self::$_this->btHandle = 'image';
    ...
    function testCoreBlockHeaderItemsWithCustomTemplate() {
	...
	function testCoreBlockHeaderDirectoryItemsWithCustomTemplate() {
		// Test h
		self::$_this->headerItem1Count = 0;
		self::$_this->headerItem2Count = 0;
		self::$_this->btHandle = 'image';
	...
	function _testHeaderItems($browser) {
	...
	function _testHeaderItemDirectories($browser) {
